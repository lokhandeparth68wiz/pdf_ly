...
const tools = [
  {
    ...
    icon: <CopyPlus className="h-8 w-8 text-blue-400 group-hover:text-blue-300 transition-colors" />,
    href: "/merge",
  ...
  },
  {
    ...
    icon: <FileEdit className="h-8 w-8 text-emerald-400 group-hover:text-emerald-300 transition-colors" />,
    href: "/edit",
  ...
  },
  {
    ...
    icon: <FileArchive className="h-8 w-8 text-amber-400 group-hover:text-amber-300 transition-colors" />,
    href: "/compress",
  ...
  },
  {
    ...
    icon: <FileText className="h-8 w-8 text-purple-400 group-hover:text-purple-300 transition-colors" />,
    href: "/pdf-to-docx",
  ...
  },
  {
    ...
    icon: <FileType2 className="h-8 w-8 text-rose-400 group-hover:text-rose-300 transition-colors" />,
    href: "/docx-to-pdf",
